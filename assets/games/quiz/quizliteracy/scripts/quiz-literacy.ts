...
export class QuizLiteracy extends cc.Component {
  ...
  protected onLoad(): void {
    ...
    console.log(
      "quizLiteracy onLoad() ",
      config,
      `${config.currentGameLessonId}/res`,
      Config.dir + `${config.currentGameLessonId}/res`,
      Profile.lang + "/" + this._quizLiteracyConfig.problemNo,
      this._quizLiteracyConfig.soundFile
    );
    // this._assetDir = Config.dir + `${this._quizLiteracyConfig.problemNo}/res`;
    this._assetDir =
      Config.dir +
      `${
        config.lesson.type === EXAM
          ? this._quizLiteracyConfig.problemNo
          : config.currentGameLessonId
      }/res`;
    console.log("quiz asset location this._assetDir =", this._assetDir);
    ...
    switch (this._quizLiteracyConfig.type) {
      ...
      case IMAGE_IMAGE:
        ...
        const imageSentenceComponent =
          imageSentence.getComponent(ImageSentence);
      ...
      case IMAGESEQ_IMAGE:
        ...
        const imageSeqImageComponent =
          imageSeqImage.getComponent(ImageSeqImage);
      ...
      case IMAGESEQ_SENTENCE:
        ...
        const imageSeqSentenceComponent =
          imageSeqSentence.getComponent(ImageseqSentence);
      ...
      case SOUNDONLY_IMAGE:
        console.log(
          ...
          this._quizLiteracyConfig
        );

        const soundonlyImage = cc.instantiate(this.soundonlyImage);
        const soundonlyImageComponent =
          soundonlyImage.getComponent(SoundonlyImage);
        soundonlyImageComponent.quizConfig = this._quizLiteracyConfig;
      ...
      case SOUNDONLY_WORD:
        ...
        const soundonlyWordComponent =
          soundonlyWord.getComponent(SoundonlyWord);
      ...
      case SOUNDONLY_SENTENCE:
        ...
        const soundonlySentenceComponent =
          soundonlySentence.getComponent(SoundonlySentence);
      ...
      case SENTENCE_SENTENCE:
        ...
        const sentenceSentenceComponent =
          sentenceSentence.getComponent(SentenceSentence);
      ...
      case PARAGRAPH_SENTENCE:
        ...
        const paragraphSentenceComponent =
          paragraphSentence.getComponent(ParagraphSequence);
      ...
      case LISTENING_COM_SENTENCE:
        ...
        const listeningComSentenceComponent =
          listeningComSentence.getComponent(ListeningComSequence);
      ...
      case ORDERING_SENTENCE:
        ...
        const orderingSentenceComponent =
          orderingSentence.getComponent(OrderingSequence);
  ...
  private processConfiguration(data: any[] = []): QuizLiteracyConfig {
    ...
    let choices: string =
      choice1.trim() + "^" + choice2.trim() + "^" + choice3.trim();
