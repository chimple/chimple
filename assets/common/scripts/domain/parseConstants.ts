...
export const FIREBASE_SCHOOL_URL = ' https://us-central1-chimple-demo.cloudfunctions.net/chimple/getSchool?id=';
export const FIREBASE_UPDATE_HOME_TEACHER_URL = ' https://us-central1-chimple-demo.cloudfunctions.net/chimple/createStudent';
export const FIREBASE_LIST_ASSIGNMENTS = ' https://us-central1-chimple-demo.cloudfunctions.net/chimple/assignments?studentId='
export const FIREBASE_UPDATE_PROGRESS_URL = ' https://us-central1-chimple-demo.cloudfunctions.net/chimple/updateProgressOnHttp';