...
numbertrainDrag: [ function(t, e, r) {
"use strict";
cc._RF.push(e, "dcaa4SgbbtBZJfoUQLRl+uB", "numbertrainDrag");
...
var i = t("../../../common/scripts/drag"), a = cc._decorator, c = a.ccclass, u = a.property, s = function(t) {
n(e, t);
function e() {
...
o([ u(cc.Label) ], e.prototype, "num", void 0);
o([ u(cc.Node) ], e.prototype, "numbertrain", void 0);
return e = o([ c ], e);
}(i.default);
r.default = s;
cc._RF.pop();
...
numbertrainDrop: [ function(t, e, r) {
"use strict";
cc._RF.push(e, "09812f4G5hIL6AbaR79Uoxg", "numbertrainDrop");
var n = this && this.__extends || function() {
var t = function(e, r) {
return (t = Object.setPrototypeOf || {
__proto__: []
...
var i = t("../../../common/scripts/drop"), a = cc._decorator, c = a.ccclass, u = a.property, s = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.wagonBase = null;
...
o([ u(cc.Node) ], e.prototype, "wagonBase", void 0);
o([ u ], e.prototype, "order", void 0);
return e = o([ c ], e);
}(i.default);
r.default = s;
cc._RF.pop();
...
ordertractor: [ function(t, e, r) {
"use strict";
cc._RF.push(e, "0bd5b3GLgBKOoj3SG3ZINoP", "ordertractor");
var n = this && this.__extends || function() {
var t = function(e, r) {
return (t = Object.setPrototypeOf || {
__proto__: []
...
var i = t("../../../common/scripts/util"), a = t("./numbertrainDrag"), c = t("../../../common/scripts/lib/config"), u = t("./numbertrainDrop"), s = t("../../../common/scripts/drag"), l = t("../../../common/scripts/lib/error-handler"), p = cc._decorator, d = p.ccclass, f = p.property, h = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.drag = null;
...
var e = c.default.getInstance().data[0], r = (e[0], e[1], e[2], e[3]), n = "true" == e[4], o = this.generateNumbers(parseInt(r));
n && o.reverse();
this.empty = o.length;
var l = null, p = null;
o.forEach(function(e, r) {
var i = cc.instantiate(t.outerDrop), a = i.getChildByName("layout");
if (null != a) {
var c = a.getChildByName("drop");
if (null != c) {
c.name = e.toString();
c.getComponent(u.default).order = n ? o.length - r : r + 1;
0 == r && (p = c);
}
}
var s = new cc.Node();
...
r.name = e.toString();
var n = r.getComponent(a.default);
n.num.string = e.toString();
n.numbertrain = t.node;
var o = new cc.Node();
o.width = r.width;
o.height = r.height;
o.addChild(r);
...
i.Util.playSfx(t.trainClip);
}).set({
x: d + cc.winSize.width
}).to(3, {
x: d
}, {
progress: null,
...
e.prototype.generateNumbers = function(t) {
switch (t) {
case 1:
return [ 1, 2, 3, 4, 5 ];
...
e.prototype.generateIncrementals = function(t, e, r) {
void 0 === r && (r = 1);
var n = Math.floor(Math.random() * (e - t)) + t;
return [ n, n + 1 * r, n + 2 * r, n + 3 * r, n + 4 * r ];
};
e.prototype.generateMultiples = function(t, e, r) {
var n = Math.ceil(e / t), o = Math.floor(r / t) - 4, i = Math.floor(Math.random() * (o - n)) + n;
return [ i * t, (i + 1) * t, (i + 2) * t, (i + 3) * t, (i + 4) * t ];
};
e.prototype.generateRandoms = function(t, e) {
...
o([ f(cc.Prefab) ], e.prototype, "drag", void 0);
o([ f(cc.Prefab) ], e.prototype, "outerDrop", void 0);
o([ f(cc.Node) ], e.prototype, "choices", void 0);
o([ f(cc.Node) ], e.prototype, "train", void 0);
o([ f(cc.AudioClip) ], e.prototype, "trainClip", void 0);
o([ f(cc.AudioClip) ], e.prototype, "metalClink", void 0);
o([ f(cc.Node) ], e.prototype, "friendPos", void 0);
