...
writeletter: [ function(t, e, n) {
"use strict";
cc._RF.push(e, "f00d6U85lNJf7T+QE5U3/2Z", "writeletter");
...
n.WriteLetter = n.LETTER_TRACING_SCALE = void 0;
var r = cc._decorator.ccclass, c = cc._decorator.property, a = t("../../../common/scripts/lib/config"), s = t("../../../common/scripts/util"), p = t("../../../common/scripts/lib/error-handler"), l = t("../../../common/scripts/helper"), u = t("../../../common/Tracing/scripts/tracing-container");
n.LETTER_TRACING_SCALE = .85;
var d = function(t) {
o(e, t);
function e() {
...
e._letterTracingContainer = null;
e._sound = null;
e._imageName = null;
return e;
}
...
var t = this;
this.node.on(l.TRACING_FINISHED, function(e) {
e.stopPropagation();
t.tracingFinished();
});
this.node.on(l.TRACING_CORRECT, function(e) {
e.stopPropagation();
t.node.emit("correct");
});
this.node.on(l.TRACING_WRONG, function(e) {
e.stopPropagation();
t.node.emit("wrong");
});
};
...
e._sound = t;
e.node.emit(l.SOUND_LOADED_EVENT);
});
};
...
this._tracingContainerComponent = this._tracingContainer.getComponent(u.default);
...
"en/" === a.default.dir ? this._tracingContainer.setPosition(new cc.Vec2(-256, -350)) : "hi/" === a.default.dir && this._tracingContainer.setPosition(new cc.Vec2(-256, -450));
this.node.scale = n.LETTER_TRACING_SCALE;
};
...
i([ c(cc.Prefab) ], e.prototype, "tracingContainerPrefab", void 0);
i([ c(cc.Prefab) ], e.prototype, "imageNode", void 0);
i([ p.default() ], e.prototype, "onLoad", null);
i([ p.default() ], e.prototype, "subScribeToTracingEvents", null);
i([ p.default() ], e.prototype, "tracingFinished", null);
i([ p.default() ], e.prototype, "pronounce", null);
i([ p.default() ], e.prototype, "setAlphabetToDisplay", null);
return e = i([ r ], e);
}(cc.Component);
n.WriteLetter = d;
cc._RF.pop();
